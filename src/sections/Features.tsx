            ...
            <div className="container">
                ...
                <div className="mt-12 grid grid-cols-1 md:grid-cols-4 lg:grid-cols-3 gap-8">
                    ...
                    <FeatureCard
                        ...
                        description="Powerful commnads to help you create commnad more
                            quickly"
                ...
                <div className="mt-8 flex flex-wrap gap-3 justify-center">
                    {features.map((feature) => (
                        <div
                            key={feature}
                            className="bg-neutral-900 border border-white/10 inline-flex px-3 md:px-5 py-1.5 mg:py-2 rounded-2xl gap-3 items-center hover:scale-105 transition duration-500 group"
                        >
